...
builder.Services.AddScoped<DcDetailTableService>();
builder.Services.AddScoped<DcMaterialTableService>();
builder.Services.AddScoped<DcDetailRecordService>();
builder.Services.AddScoped<DcOperationService>();
builder.Services.AddScoped<DcChassisService>();
builder.Services.AddScoped<DcCardService>();
builder.Services.AddScoped<DcModuleService>();
builder.Services.AddScoped<DcUnitService>();
builder.Services.AddScoped<DcCableService>();
